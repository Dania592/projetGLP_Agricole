...
/**
 * La classe Terrain représente une morceau de la map que le joueur peut utiliser pour récolter des {@link Produits}
 */
public class Terrain extends Element implements Buyable, Produceur, ProductifPlace, WaterConsumer, Fixable, SpecialActionPerformer, Hydratable, Healable, HealablePlace{
	...
	public Terrain(String reference, boolean statique, Graine type) {
		...
		this.type = type;
		setImage(GameConfiguration.IMAGE_PATH + "Terrain" + File.separator + "Vierge.png");
	}
	...
	@Override
	public <T> T launchAction(PlaceVisitor<T> visitor, Activity activity, Graine graine) throws UnableToPerformSuchActionWithCurrentActionnable, UnableToGenerateNewTaskException, ProblemOccursInProductionException {
