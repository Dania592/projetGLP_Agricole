...
public abstract class GameConfiguration {
	...
	public final static int FREQUENCE_DECREMENTATION_ENCLOS_NOURRITURE = 100 ; // 1 animal => 25 min (60)
	
	public final static int FREQUENCE_DECREMENTATION_ENCLOS_EAU = 75 ; // 1 animal => 15 min (20)
