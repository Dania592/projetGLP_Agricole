 ...
 */
public class Abattoire extends StructureAction implements Distributor<Slaughtable>{
	...
	public Abattoire( String reference ) {
		super( reference );
		setImage(GameConfiguration.IMAGE_PATH+Saison.PRINTEMPS+File.separator+"Structure"+File.separator+"abattoire.png");	
