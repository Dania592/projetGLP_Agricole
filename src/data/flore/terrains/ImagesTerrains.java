...
public class ImagesTerrains implements Serializable{
	private static HashMap<TypeGraine, HashMap<EvolutionTerrain, String>> images = new HashMap<>();
	...
	public HashMap<TypeGraine, HashMap<EvolutionTerrain, String>> getImages() {
		initializeImages();
		return images;
	}
