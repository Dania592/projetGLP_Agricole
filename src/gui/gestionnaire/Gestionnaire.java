...
public class Gestionnaire extends JFrame {
	...
	public void init() {
		...
		JPanel principalPanel = paintStrategy.paintGestionnaire(0,0, width, height, MANAGER_ROW_COUNT, MANAGER_COLUMN_COUNT, MIN_SPACE_BETWEEN, MANAGER_CARD_WIDTH, MANAGER_CARD_HEIGHT, MANAGER_CARD_COLOR, "Manager", null, null);
